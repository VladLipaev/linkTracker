...
@Configuration
public class AiAgentKafkaTemplateConfiguration {
    ...
    @Bean
    public ProducerFactory<String, ProcessedLinkUpdateAvro> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, ProcessedLinkUpdateAvro> kafkaTemplate() {
