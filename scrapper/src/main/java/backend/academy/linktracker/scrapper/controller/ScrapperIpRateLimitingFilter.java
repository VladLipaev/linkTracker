...
@Component
public class ScrapperIpRateLimitingFilter extends OncePerRequestFilter {

    private final RateLimiterRegistry rateLimiterRegistry;
    private final Cache<String, RateLimiter> rateLimiterCache;

    public ScrapperIpRateLimitingFilter(
    ...
    private void onCacheRemoval(String key, RateLimiter value, RemovalCause cause) {
        if (key != null) {
